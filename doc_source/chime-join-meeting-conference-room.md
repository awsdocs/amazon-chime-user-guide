...
1. Enter **meet\.chime\.in** for a SIP call or **52\.23\.133\.56** for an H\.323 call\.

1. Choose **Call** and wait a few seconds to connect to Amazon Chime\.

1. After you hear the greeting, enter the 10\-digit meeting ID from the meeting invite, followed by "\#"\.
